          ...
          children: [
            Row(
              children:  [
                ...
                Image.asset('assets/eagle1.png'),
                Image.network('https://images-na.ssl-images-amazon.com/images/I/81HgVEqBVuL._SL1500_.jpg',width:200,height: 300),
               
              ],
              
            ),
            Text("hello,Welcomeee to task 2",style:TextStyle(fontSize: 20)),
            SizedBox(height:10),
            ...
            Row(
              children: [
                ...
                Icon(Icons.add_alarm_outlined,size: 50,),
